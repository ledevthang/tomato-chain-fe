      ...
      <v-card-actions style="flex-direction: column">
        ...
        <!-- <div class="note-dashboard-zone">
          <div class="note-dashboard">
            <div>Extensions and Mobile Apps allowed to connect to <b>TomatoCheck</b> account:</div>
            <div><b>On Desktop</b>: MetaMask extensions</div>
            <div><b>On Mobile</b>: Trust support</div>
            <div>Please access our website through browser of the wallet app to connect your wallet to <b>TomatoCheck</b> account.</div>
          </div>
        </div> -->
      </v-card-actions>
    </v-card>
